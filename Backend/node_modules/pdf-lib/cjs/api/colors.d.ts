...
export declare const setFillingColor: (color: Color) => import("pdf-lib/cjs/core/operators/PDFOperator").default;
export declare const setStrokingColor: (color: Color) => import("pdf-lib/cjs/core/operators/PDFOperator").default;
