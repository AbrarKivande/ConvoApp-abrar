import { PDFOperator, PDFWidgetAnnotation } from "pdf-lib/cjs/core";
import PDFFont from "pdf-lib/cjs/api/PDFFont";
import PDFButton from "pdf-lib/cjs/api/form/PDFButton";
import PDFCheckBox from "pdf-lib/cjs/api/form/PDFCheckBox";
import PDFDropdown from "pdf-lib/cjs/api/form/PDFDropdown";
import PDFField from "pdf-lib/cjs/api/form/PDFField";
import PDFOptionList from "pdf-lib/cjs/api/form/PDFOptionList";
import PDFRadioGroup from "pdf-lib/cjs/api/form/PDFRadioGroup";
import PDFSignature from "pdf-lib/cjs/api/form/PDFSignature";
import PDFTextField from "pdf-lib/cjs/api/form/PDFTextField";
